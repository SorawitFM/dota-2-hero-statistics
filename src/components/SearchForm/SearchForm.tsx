...
const SearchForm = () => {
    ...
    return (
        <div className="col m-3 p-3 rounded" style={{ backgroundColor: 'rgba(201, 11, 11, 0.4)', fontFamily: 'Georgia, serif' }}>
            <form className="grid container" >
                <div className="d-flex flex-wrap justify-content-evenly gap-2" style={{ position: 'relative' }}>
                    ...
                    <div className="col" style={{ minWidth: '150px' }}>
                        <label className="form-label text-light f-bold fs-5" htmlFor="sort">Sort by</label>
                    ...
                    {/* Dropdown 2 */}
                    <div className="col" style={{ minWidth: '150px' }}>
                        <label className="form-label text-light f-bold fs-5" htmlFor="attribute">Attributes</label>
                    ...
                    {/* Dropdown 3 */}
                    <div className="col" style={{ minWidth: '150px' }}>
                        <label className="form-label text-light f-bold fs-5" htmlFor="role">Roles</label>
                    ...
                    {/* Dropdown 4 */}
                    <div className="col" style={{ minWidth: '150px' }}>
                        <label className="form-label text-light f-bold fs-5" htmlFor="rank">Ranks</label>
                    ...
                    <div className="col" style={{ minWidth: '150px' }}>
                        ...
                        <div className="mb-3">
                            <label htmlFor="keyword" className="form-label text-light f-bold fs-5">Search</label>
                            <div className="d-flex justify-content-between gap-2">
                                <input {...fieldKeyword}
                                    type="search" className="form-control" id="keyword" placeholder="Search Hero's name" />
